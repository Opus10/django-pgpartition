# -*- coding: utf-8 -*-
#
# django-pgpartition documentation build configuration file, created by
...
version = pgpartition.__version__
...
htmlhelp_basename = "django-pgpartitiondoc"
...
latex_documents = [
    (
        master_doc,
        "django-pgpartition.tex",
        "django-pgpartition Documentation",
        "Opus 10",
        "manual",
    )
]
